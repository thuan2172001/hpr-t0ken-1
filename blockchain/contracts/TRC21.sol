...
contract TRC21 is ITRC21 {
     ...
     */
    function estimateFee(uint256 value) override public view returns (uint256) {
...
contract MyTRC21Mintable is TRC21, MinterRole {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, uint256 cap, uint256 minFee) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
